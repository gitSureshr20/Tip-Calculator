...
function calculateBill(){
  ...
  totalTipPaid.textContent=Math.round(getTipAmount);
  totalAmountToPay.textContent=Math.round(totalBill);
  eachCustomerToPay.textContent=Math.round(eachCustomerToPayAmount);
